...
**Author Notes:** 
Still need to set up a script to create the db tables used by the application. We also need to set params for running in production mode, and set the port to 80.